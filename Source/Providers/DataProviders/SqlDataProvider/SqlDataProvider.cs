...
//        private string providerPath;
        ...
        public override int InsertJob(int userId, int positionId, int locationId, int categoryId, bool isHot, bool isFilled, string requiredQualifications, string desiredQualifications, int sortOrder, int portalId, string notificationEmailAddress)
        {
        ...
        public override void UpdateJob(int userId, int jobId, int positionId, int locationId, int categoryId, bool isHot, bool isFilled, string requiredQualifications, string desiredQualifications, int sortOrder, string notificationEmailAddress)
        {
        ...
        public override IDataReader GetJob(int jobId)
        {
            ...
            sql.Append(" CategoryName, CategoryId, IsHot, IsFilled, JobDescription, SortOrder ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " from {0}vwJobs ", NamePrefix);
        ...
        {
            return GetJobs(onlyHotJobs, null, jobGroupId, portalId);
        }
        ...
        public override IDataReader GetJobs(bool onlyHotJobs, int? maximumNumberOfJobs, int? jobGroupId, int portalId)
        {
            ...
            sql.Append("j.IsHot, j.IsFilled, j.PostedDate, j.JobDescription, j.SortOrder, j.NotificationEmailAddress ");
            sql.Append("from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, "{0}vwJobs j ", NamePrefix);
            if (jobGroupId.HasValue)
            {
                sql.AppendFormat(CultureInfo.InvariantCulture, " join {0}JobJobGroup jlg on (j.JobId = jlg.JobId) ", NamePrefix);
            }
            sql.Append(" where ");
            ...
            return SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(),
                Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId), Engage.Utility.CreateIntegerParam("@portalId", portalId));
        }
        ...
        public override bool CanCreateJob(int portalId)
        {
            ...
            sql.AppendFormat("select top 1 null from {0}vwLocations l", NamePrefix);
            sql.AppendFormat(" join {0}vwPositions p on (p.PortalId = l.PortalId)", NamePrefix);
            sql.AppendFormat(" join {0}vwCategories c on (c.PortalId = p.PortalId)", NamePrefix);
            sql.Append("where l.portalId = @portalId");

            using (IDataReader dr = SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateIntegerParam("@portalId", portalId)))
            {
                return dr.Read();
            }
        ...
        public override IDataReader GetJobs(int? userId, int? jobGroupId, int portalId)
        {
            ...
            sql.Append(" from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " {0}vwApplications a ", NamePrefix);
            if (jobGroupId.HasValue)
            {
                sql.AppendFormat(CultureInfo.InvariantCulture, " join {0}JobJobGroup jlg on (a.JobId = jlg.JobId) ", NamePrefix);
            }
            ...
            return SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@userId", userId),
                Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId), Engage.Utility.CreateIntegerParam("@portalId", portalId));
        }
        ...
        public override bool HasUserAppliedForJob(int jobId, int userId)
        {
            ...
            sql.Append(" from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " {0}vwApplications ", NamePrefix);
            sql.Append(" where ");
        ...
        {
            StringBuilder sql = new StringBuilder(147);
            sql.Append(" select ApplicationId, UserId, DisplayName, JobId, AppliedDate, SalaryRequirement, Message, StatusId ");
            sql.AppendFormat(" from {0}vwApplications ", NamePrefix);
            sql.Append(" where ApplicationId = @applicationId ");

            return SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@applicationId", applicationId));
        }
        ...
        public override int InsertApplication(int jobId, int? userId, string salaryRequirement, string message)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, " insert {0}vwApplications ", NamePrefix);
            ...
            return (int)(decimal)SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateIntegerParam("@userId", userId),
                Engage.Utility.CreateIntegerParam("@jobId", jobId), 
        ...
        public override void UpdateApplication(int applicationId, string salaryRequirement, string message)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, " update {0}vwApplications ", NamePrefix);
        ...
        public override DataTable GetApplications(int? jobGroupId, int portalId)
        {
            ...
            sql.Append(" select ");
            sql.Append(" a.AppliedDate, a.DisplayName, a.JobId, a.JobTitle, a.LocationName, a.ApplicationId, a.UserId, a.SalaryRequirement, a.Message ");
            sql.Append(" from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " {0}vwApplications a ", NamePrefix);
            if (jobGroupId.HasValue)
            {
            ...
            return SqlHelper.ExecuteDataset(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId), Engage.Utility.CreateIntegerParam("@portalId", portalId)).Tables[0];
        }
        ...
        public override IDataReader GetApplicationsForJob(int jobId, int? jobGroupId)
        {
            ...
            return SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateIntegerParam("@jobId", jobId), Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId));
        }
        #endregion
        ...
        public override DataTable GetApplicationDocuments(int applicationId)
        {
            ...
            sql.Append(" from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " {0}vwDocuments ", NamePrefix);
            sql.Append(" where ");
        ...
        public override IDataReader GetDocumentType(string documentTypeName, int? portalId)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, "select documentTypeId, description from {0}DocumentType ", NamePrefix);
            sql.Append(" where description = @documentTypeName ");
            sql.Append(" and (PortalId = @portalId OR (PortalId IS NULL and @portalId IS NULL)) ");

            return SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateVarcharParam("@documentTypeName", documentTypeName), Engage.Utility.CreateIntegerParam("@portalId", portalId));
        }

        public override IDataReader GetDocumentType(int documentTypeId)
        {
            StringBuilder sql = new StringBuilder(128);
            sql.AppendFormat(CultureInfo.InvariantCulture, "select documentTypeId, description from {0}DocumentType where documentTypeId = @documentTypeId", NamePrefix);
        ...
        {
            return InsertDocument(applicationId, userId, fileName, resumeType, resume, DocumentType.Resume.GetId());
        }
        ...
        {
            return InsertDocument(applicationId, userId, fileName, contentType, document, documentTypeId, true);
        }
        ...
        public override int InsertDocument(int applicationId, int? userId, string fileName, string contentType, byte[] document, int documentTypeId, bool removeOldDocuments)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, " insert {0}Document ", NamePrefix);
            ...
            int resumeId = (int)(decimal)SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sql.ToString(),
                Engage.Utility.CreateIntegerParam("@userId", userId), Engage.Utility.CreateVarcharParam("@fileName", fileName, VarcharLength),
                Engage.Utility.CreateVarcharParam("@contentType", contentType), Engage.Utility.CreateIntegerParam("@contentLength", document.Length),
                Engage.Utility.CreateImageParam("@resumeData", document), Engage.Utility.CreateIntegerParam("@documentTypeId", documentTypeId));

            if (removeOldDocuments)
            {
                RemoveDocumentAssignements(applicationId, documentTypeId);
            }
            AssignDocumentToApplication(applicationId, resumeId);
            return resumeId;
        }
        ...
        {
            return GetDocumentId(DocumentType.Resume.GetId(), userId);
        }
        ...
        public override int GetResumeIdForApplication(int applicationId)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, "select d.ResumeId from {0}Document d ", NamePrefix);
            sql.AppendFormat(CultureInfo.InvariantCulture, " join {0}ApplicationDocument ad ON (d.ResumeId = d.ResumeId) ", NamePrefix);
            sql.Append(" where ad.ApplicationId = @applicationId ");
            sql.Append(" and d.DocumentTypeId = @documentTypeId ");

            object resumeId = SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sql.ToString(),
                Engage.Utility.CreateIntegerParam("@applicationId", applicationId), Engage.Utility.CreateIntegerParam("@documentTypeId", DocumentType.Resume.GetId()));
        ...
        public override int GetDocumentId(int documentTypeId, int userId)
        {
            ...
            StringBuilder sql = new StringBuilder(255);
            sql.AppendFormat(CultureInfo.InvariantCulture, "select max(ResumeId) from {0}Document ", NamePrefix);
            sql.Append(" where UserId = @userId ");
            sql.Append(" and DocumentTypeId = @documentTypeId ");

            object resumeId = SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateIntegerParam("@userId", userId), Engage.Utility.CreateIntegerParam("@documentTypeId", documentTypeId));
        ...
        {
            StringBuilder sql = new StringBuilder(128);
            sql.AppendFormat(CultureInfo.InvariantCulture, "INSERT INTO {0}ApplicationDocument (ApplicationId, ResumeId)", NamePrefix);
            sql.Append("values (@applicationId, @resumeId)");

            SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateIntegerParam("@applicationId", applicationId), Engage.Utility.CreateIntegerParam("@resumeId", resumeId));
        }

        private void RemoveDocumentAssignements(int applicationId, int documentTypeId)
        {
            StringBuilder sql = new StringBuilder(128);
            sql.AppendFormat(CultureInfo.InvariantCulture, "DELETE {0}ApplicationDocument ", NamePrefix);
            sql.AppendFormat(CultureInfo.InvariantCulture, " FROM {0}ApplicationDocument ad ", NamePrefix);
            sql.AppendFormat(CultureInfo.InvariantCulture, " JOIN {0}Document d ON (ad.ResumeId = d.ResumeId) ", NamePrefix);
            sql.Append(" WHERE ad.ApplicationId = @applicationId ");
            sql.Append(" AND d.DocumentTypeId = @documentTypeId ");

            SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.Text, sql.ToString(),
                Engage.Utility.CreateIntegerParam("@applicationId", applicationId), Engage.Utility.CreateIntegerParam("@documentTypeId", documentTypeId));
        }
        ...
        public override IDataReader GetState(int stateId)
        {
            ...
            sql.Append(" from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " {0}vwStates ", NamePrefix);
            sql.Append(" where ");
        ...
        public override int? GetStateId(string name, int portalId)
        {
            ...
            object stateId = SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateVarcharParam("@stateName", name, VarcharLength), 
                Engage.Utility.CreateIntegerParam("@portalId", portalId));
        ...
        public override bool IsStateUsed(int stateId)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, " select top 1 NULL from {0}vwLocations where StateId = @stateId", NamePrefix);

            using (IDataReader dr = SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@stateId", stateId)))
            {
                return dr.Read();
            }
        }
        ...
        public override IDataReader GetLocation(int locationId)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, " from {0}vwLocations ", NamePrefix);
        ...
        public override int? GetLocationId(string locationName, int? stateId, int portalId)
        {
            ...
            sql.Append(" from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " {0}vwLocations ", NamePrefix);
            sql.Append(" where ");
            ...
            object locationId = SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateVarcharParam("@locationName", locationName, VarcharLength), 
                Engage.Utility.CreateIntegerParam("@portalId", portalId),
                Engage.Utility.CreateIntegerParam("@stateId", stateId));
        ...
        public override bool IsLocationUsed(int locationId)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, " select top 1 LocationId from {0}vwJobs where LocationId = @locationId", NamePrefix);

            using (IDataReader dr = SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@locationId", locationId)))
            {
                return dr.Read();
            }
        }
        ...
        public override IDataReader GetCategory(int categoryId)
        {
            ...
            sql.Append(" from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " {0}vwCategories ", NamePrefix);
            sql.Append(" where ");
        ...
        {
            StringBuilder sql = new StringBuilder(128);
            sql.AppendFormat(CultureInfo.InvariantCulture, "select top 1 CategoryId from {0}vwCategories where CategoryName = @name and PortalId = @portalId", NamePrefix);

            object categoryId = SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateVarcharParam("@name", categoryName, VarcharLength), Engage.Utility.CreateIntegerParam("@portalId", portalId));
        ...
        public override IDataReader GetPosition(int positionId)
        {
            ...
            sql.Append(" from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " {0}vwPositions ", NamePrefix);
            sql.Append(" where ");
            sql.Append(" PositionId = @positionId ");

            return SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@positionId", positionId));
        }
        ...
        public override int? GetPositionId(string name, int portalId)
        {
            ...
            object positionId = SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sql.ToString(), 
        ...
        {
            StringBuilder sql = new StringBuilder(97);
            sql.AppendFormat(CultureInfo.InvariantCulture, " SELECT TOP 1 NULL FROM {0}vwJobs WHERE PositionId = @positionId", NamePrefix);

            using (IDataReader dr = SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@positionId", positionId)))
            {
                return dr.Read();
            }
        }
        ...
        public override DataTable GetUserStatuses(int portalId)
        {
            ...
            sql.Append(" from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " {0}vwUserStatuses ", NamePrefix);
        ...
        public override DataTable GetUserStatus(int statusId)
        {
            ...
            return SqlHelper.ExecuteDataset(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateIntegerParam("@statusId", statusId)).Tables[0];
        }
        ...
        public override void UpdateUserStatus(int statusId, string statusName)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, " update {0}vwUserStatuses ", NamePrefix);
            sql.Append(" set ");
        ...
        public override void InsertUserStatus(string statusName, int portalId)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, " insert {0}vwUserStatuses ", NamePrefix);
            sql.Append(" (StatusName, PortalId ) ");
            sql.Append(" values (@status, @portalId)");

            SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateVarcharParam("@status", statusName, VarcharLength), Engage.Utility.CreateIntegerParam("@portalId", portalId));
        }

        public override void DeleteUserStatus(int statusId)
        {
            SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.Text, "delete " + NamePrefix + "vwUserStatuses where UserStatusId = @stausId", 
                Engage.Utility.CreateIntegerParam("@stausId", statusId));
        }

        public override int? GetUserStatusId(string status, int portalId)
        {
            StringBuilder sql = new StringBuilder(128);
            sql.AppendFormat(CultureInfo.InvariantCulture, "select top 1 UserStatusId from {0}vwUserStatuses where StatusName = @status and PortalId = @portalId", NamePrefix);

            object statusId = SqlHelper.ExecuteScalar(ConnectionString, CommandType.Text, sql.ToString(), 
        ...
        {
            StringBuilder sql = new StringBuilder(299);
            sql.AppendFormat(CultureInfo.InvariantCulture, " declare @propertyId int{0}", Environment.NewLine);
            sql.AppendFormat(CultureInfo.InvariantCulture, " select @propertyId = PropertyDefinitionId from {0}{1}ProfilePropertyDefinition where PropertyCategory = 'Engage: Employment' and PropertyName = '{2}'{3}", DatabaseOwner, ObjectQualifier, Utility.UserStatusPropertyName, Environment.NewLine);
            sql.AppendFormat(CultureInfo.InvariantCulture, " select top 1 null as EmptyColumn from {0}{1}UserProfile where PropertyDefinitionID = @propertyId and PropertyValue = @statusId", DatabaseOwner, ObjectQualifier);
            using (IDataReader dr = SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@statusId", statusId)))
            {
                return dr.Read();
            }
        }
        ...
        {
            return SqlHelper.ExecuteDataset(ConnectionString, CommandType.Text, string.Format(CultureInfo.InvariantCulture, "SELECT JobGroupId, [Name] FROM {0}JobGroup WHERE PortalId = @portalId ORDER BY [Name]", NamePrefix), Engage.Utility.CreateIntegerParam("@portalId", portalId)).Tables[0];
        }
        public override DataTable GetJobGroup(int jobGroupId)
        {
            return SqlHelper.ExecuteDataset(ConnectionString, CommandType.Text, string.Format(CultureInfo.InvariantCulture, "SELECT JobGroupId, [Name] FROM {0}JobGroup WHERE JobGroupId = @jobGroupId", NamePrefix), Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId)).Tables[0];
        }

        public override void UpdateJobGroup(int jobGroupId, string jobGroupName)
        {
            StringBuilder sql = new StringBuilder(128);
            sql.AppendFormat(CultureInfo.InvariantCulture, "UPDATE {0}JobGroup ", NamePrefix);
            sql.Append(" SET [Name] = @jobGroupName ");
            sql.Append(" WHERE JobGroupId = @jobGroupId ");

            SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId), Engage.Utility.CreateVarcharParam("@jobGroupName", jobGroupName, 255));
        }

        public override void InsertJobGroup(string jobGroupName, int portalId)
        {
            StringBuilder sql = new StringBuilder(86);
            sql.AppendFormat(CultureInfo.InvariantCulture, "INSERT INTO {0}JobGroup ([NAME], [PortalId])", NamePrefix);
            sql.Append("VALUES (@jobGroupName, @portalId)");

            SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateVarcharParam("@jobGroupName", jobGroupName, VarcharLength), Engage.Utility.CreateIntegerParam("@portalId", portalId));
        }

        public override bool IsJobGroupUsed(int jobGroupId)
        {
            StringBuilder sql = new StringBuilder(97);
            sql.AppendFormat(CultureInfo.InvariantCulture, "select top 1 JobGroupId from {0}JobJobGroup where JobGroupId = @jobGroupId", NamePrefix);

            using (IDataReader dr = SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId)))
            {
                return dr.Read();
            }
        }
        ...
        {
            StringBuilder sql = new StringBuilder(97);
            sql.AppendFormat(CultureInfo.InvariantCulture, "select top 1 JobGroupId from {0}JobGroup where Name = @jobGroupName and PortalId = @portalId", NamePrefix);

            using (IDataReader dr = SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateVarcharParam("@jobGroupName", jobGroupName, VarcharLength), Engage.Utility.CreateIntegerParam("@portalId", portalId)))
            {
                return dr.Read();
            }
        }
        ...
        {
            SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.Text, string.Format(CultureInfo.InvariantCulture, "DELETE {0}JobGroup WHERE JobGroupId = @jobGroupId", NamePrefix), Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId));
        }
        #endregion
        ...
        public override void AssignJobToJobGroups(int jobId, List<int> jobGroups)
        {
            using (SqlConnection conn = new SqlConnection(ConnectionString))
            {
                ...
                using (SqlTransaction tran = conn.BeginTransaction())
                {
                    ...
                    SqlHelper.ExecuteNonQuery(tran, CommandType.Text, String.Format(CultureInfo.InvariantCulture, "DELETE FROM {0}JobJobGroup WHERE JobId = @JobId", NamePrefix), Engage.Utility.CreateIntegerParam("@JobId", jobId));

                    //Add back the selected JobGroup assignments
                    if (jobGroups != null && jobGroups.Count > 0)
                    {
                        StringBuilder sql = new StringBuilder(114);
                        sql.AppendFormat(CultureInfo.InvariantCulture, "INSERT {0}JobJobGroup (JobId, JobGroupId) ", NamePrefix);
        ...
        {
            StringBuilder jobsSql = new StringBuilder(1024);
            ...
            jobsSql.AppendFormat(CultureInfo.InvariantCulture, "from {0}vwJobs ", NamePrefix);
            jobsSql.Append("where PortalId = @portalId ");

            StringBuilder jobGroupSql = new StringBuilder(128);
            jobGroupSql.Append("select ");
            jobGroupSql.Append("jjg.JobId, jg.JobGroupId, jg.Name ");
            jobGroupSql.AppendFormat(CultureInfo.InvariantCulture, "from {0}JobGroup jg ", NamePrefix);
            jobGroupSql.AppendFormat(CultureInfo.InvariantCulture, "join {0}JobJobGroup jjg on (jjg.JobGroupId = jg.JobGroupId) ", NamePrefix);
            ...
            using (SqlConnection conn = new SqlConnection(ConnectionString))
            {
                ...
                using (SqlDataAdapter adapter = new SqlDataAdapter(jobsSql.ToString(), conn))
                {
                    conn.Open();
                    adapter.SelectCommand.Parameters.Add(Engage.Utility.CreateIntegerParam("@portalId", portalId));
                    adapter.Fill(ds, "Jobs");
                }
                using (SqlDataAdapter adapter = new SqlDataAdapter(jobGroupSql.ToString(), conn))
                {
                    adapter.SelectCommand.Parameters.Add(Engage.Utility.CreateIntegerParam("@portalId", portalId));
        ...
        {
            StringBuilder sql = new StringBuilder(128);
            sql.AppendFormat(CultureInfo.InvariantCulture, "select top 1 jobgroupid from {0}JobJobGroup where jobId = @jobId and jobgroupid = @jobGroupId", NamePrefix);

            using (IDataReader dr = SqlHelper.ExecuteReader(this.ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@jobId", jobId), Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId)))
            {
                return dr.Read();
            }
        }
        ...
        public override IDataReader GetJobSearchQuery(int jobSearchQueryId)
        {
            ...
            sql.Append(" from ");
            sql.AppendFormat(CultureInfo.InvariantCulture, " {0}vwSavedSearches ", NamePrefix);
            sql.Append(" where UserSearchId = @searchId ");

            return SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@searchId", jobSearchQueryId));
        }
        ...
        public override IDataReader GetJobSearchQueries(int userId, int? jobGroupId, int portalId)
        {
            ...
            return SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateIntegerParam("@userId", userId), Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId), 
                Engage.Utility.CreateIntegerParam("@portalId", portalId));
        }
        ...
        public override DataTable GetJobSearchResults(int? positionId, int? categoryId, int? locationId, int? stateId, int? jobGroupId, int portalId)
        {
            ...
            if (jobGroupId.HasValue)
            {
                sql.AppendFormat(CultureInfo.InvariantCulture, " join {0}JobJobGroup jjg on (j.JobId = jjg.JobId) ", NamePrefix);
            }
            ...
            return SqlHelper.ExecuteDataset(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateIntegerParam("@positionId", positionId), Engage.Utility.CreateIntegerParam("@locationId", locationId), 
                Engage.Utility.CreateIntegerParam("@stateId", stateId), Engage.Utility.CreateIntegerParam("@jobGroupId", jobGroupId),
                Engage.Utility.CreateIntegerParam("@portalId", portalId), Engage.Utility.CreateIntegerParam("@categoryId", categoryId)).Tables[0];
        }
            ...
            if (keywords != null)
            {
                using (SqlConnection conn = new SqlConnection(ConnectionString))
                {
                    ...
                    using (SqlCommand cmd = conn.CreateCommand())
                    {
                        ...
                        for (int i = 0; i < keywords.Count; i++)
                        {
                            cmd.Parameters.Add(Engage.Utility.CreateVarcharParam("@keyword" + i.ToString(CultureInfo.InvariantCulture),
        ...
        public override void SaveJobSearchQuery(int userId, string searchName, int? positionId, int? categoryId, int? stateId, int? locationId, string keywords, int? jobGroupId, int portalId)
        {
        ...
        {
            SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.Text, "delete " + NamePrefix + "UserJobSearch where UserSearchId = " + jobSearchQueryId);
        }
        #endregion
        ...
        {
            StringBuilder sql = new StringBuilder(228);
            sql.AppendFormat(CultureInfo.InvariantCulture, "select top 1 ApplicationPropertyId from {0}UserJobProperty ", NamePrefix);
            ...
            return SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@ApplicationPropertyId", propertyId),
                Engage.Utility.CreateVarcharParam("@propertyValue", value, ApplicationPropertyValueLength), Engage.Utility.CreateTextParam("@propertyText", value)).Read();
        }
        ...
        public override IDataReader GetApplicationProperty(string name, int? portalId)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, " from {0}ApplicationProperty ", NamePrefix);
            sql.Append(" where PropertyName = @PropertyName ");
            sql.Append(" and (PortalId = @portalId OR (PortalId IS NULL and @portalId IS NULL)) ");

            return SqlHelper.ExecuteReader(ConnectionString, CommandType.Text, sql.ToString(), 
                Engage.Utility.CreateVarcharParam("@PropertyName", name), Engage.Utility.CreateIntegerParam("@portalId", portalId));
        }
        ...
        public override DataTable GetApplicationProperties(int applicationId)
        {
            ...
            sql.AppendFormat(CultureInfo.InvariantCulture, " from {0}UserJobProperty ujp ", NamePrefix);
            sql.AppendFormat(CultureInfo.InvariantCulture, " join {0}ApplicationProperty ap ON (ujp.ApplicationPropertyId = ap.ApplicationPropertyId) ", NamePrefix);
            sql.Append(" where ApplicationId = @ApplicationId ");

            return SqlHelper.ExecuteDataset(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@ApplicationId", applicationId)).Tables[0];
        }

        public override void InsertApplicationProperty(int applicationId, int propertyId, string value)
        {
            StringBuilder sql = new StringBuilder(512);
            sql.AppendFormat(CultureInfo.InvariantCulture, "INSERT INTO {0}UserJobProperty ", NamePrefix);
            ...
            SqlHelper.ExecuteNonQuery(ConnectionString, CommandType.Text, sql.ToString(), Engage.Utility.CreateIntegerParam("@applicationId", applicationId),
                Engage.Utility.CreateIntegerParam("@applicationPropertyId", propertyId), propertyValue, propertyText,
                Engage.Utility.CreateBitParam("@Visibility", true), Engage.Utility.CreateDateTimeParam("@LastUpdatedDate", DateTime.Now));
        }

        public override void UpdateApplicationProperty(int applicationId, int propertyId, string value)
        {
            StringBuilder sql = new StringBuilder(512);
            sql.AppendFormat(CultureInfo.InvariantCulture, "UPDATE {0}UserJobProperty ", NamePrefix);
        ...
        /// </summary>
        /// <param name="storedProcedureName">Name of the stored procedure.  Does not include any prefix, for example "InsertJob" is translated to "dnn_EngageEmployment_spInsertJob."</param>
        ...
        /// </summary>
        /// <param name="storedProcedureName">Name of the stored procedure.  Does not include any prefix, for example "GetJobs" is translated to "dnn_EngageEmployment_spGetJobs."</param>
        /// <param name="parameters">The parameters for this query.</param>
        ...
        {
            return SqlHelper.ExecuteReader(connectionString, CommandType.Text, "select Word from " + NamePrefix + "lkpCommonWords");
        }
