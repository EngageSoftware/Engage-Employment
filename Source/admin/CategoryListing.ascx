    ...
    <Columns>
        <asp:TemplateField HeaderText="CategoryName">
            <ItemTemplate>
                ...
                <asp:HiddenField ID="CategoryIdHiddenField" runat="server" Value='<%#((int)Eval("CategoryId")).ToString(CultureInfo.InvariantCulture) %>' />
            </ItemTemplate>
            <EditItemTemplate>
                <asp:TextBox ID="CategoryNameTextBox" runat="server" Text='<%#Eval("CategoryName") %>' CssClass="NormalTextBox" />
                <asp:HiddenField ID="CategoryIdHiddenField" runat="server" Value='<%#((int)Eval("CategoryId")).ToString(CultureInfo.InvariantCulture) %>' />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="CategoryNameTextBox" Display="None" ValidationGroup="Edit" resourcekey="CategoryNameRequired" />
                <asp:RegularExpressionValidator runat="server" ControlToValidate="CategoryNameTextBox" Display="None" ValidationGroup="Edit" ValidationExpression="<%#MaxLengthValidationExpression %>" ErrorMessage="<%#MaxLengthValidationText %>" />
            </EditItemTemplate>
        </asp:TemplateField>
