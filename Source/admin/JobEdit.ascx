...
<table>
    ...
    <tr>
        ...
        <td valign="top">
            <dnn:DnnDatePicker ID="StartDateTextBox" runat="server" CssClass="NormalTextBox DatePicker" Calendar-ShowRowHeaders="false" Skin="Metro" />
    ...
    <tr>
        ...
        <td valign="top">
            <dnn:DnnDatePicker ID="ExpireDateTextBox" runat="server" CssClass="NormalTextBox DatePicker" Calendar-ShowRowHeaders="false" Skin="Metro" />
        </td>
    </tr>
    <tr>
        <td class="SubHead">
