...
<%@ Control language="C#" Inherits="Engage.Dnn.Employment.Admin.ApplicationStatusListing" AutoEventWireup="false" Codebehind="ApplicationStatusListing.ascx.cs" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<span class="Head"><dnn:Label ResourceKey="lblStatusesHeader" runat="server" /></span>

<asp:Button ID="AddButton" runat="server" resourcekey="btnAdd" />
<asp:GridView ID="StatusesGrid" runat="server" AutoGenerateColumns="False" CssClass="employmentTable" BorderStyle="None" GridLines="None">
    ...
    <Columns>
        <asp:TemplateField HeaderText="StatusName">
            ...
            <EditItemTemplate>
                <asp:TextBox ID="StatusTextBox" runat="server" Text='<%#Eval("StatusName") %>' CssClass="NormalTextBox" />
                <asp:HiddenField ID="StatusIdHiddenField" runat="server" Value='<%#((int)Eval("StatusId")).ToString(CultureInfo.InvariantCulture) %>' />
...
<asp:Panel ID="pnlNew" runat="server" Visible="false">
    <table class="employmentTable">
        ...
        <tr class='<%=pnlNew.CssClass %>'><td>
            ...
            <asp:Button ID="CancelNewStatusButton" runat="server" resourcekey="btnCancelNew" CausesValidation="false" />
        </td></tr>
    </table>
    ...
    <asp:RegularExpressionValidator ID="regexNewStatus" runat="server" ControlToValidate="txtNewStatus" Display="None" ValidationGroup="New" />
</asp:Panel>
<asp:CustomValidator ID="cvDuplicateStatus" runat="server" Display="None" ValidationGroup="Edit" resourcekey="DuplicateStatus.Text" />
