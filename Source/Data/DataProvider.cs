...
namespace Engage.Dnn.Employment.Data
{
    ...
    internal abstract class DataProvider
    {
        ...
        public abstract int InsertDocument(int applicationId, int? userId, string fileName, string contentType, byte[] document, int documentTypeId, bool removeOldDocuments);
